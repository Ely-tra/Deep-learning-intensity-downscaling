    ...
    for dense_layer in dense_layers:
        for layer_size in layer_sizes:
            for conv_layer in conv_layers:
                ...
                x = layers.Conv2D(filters=98,kernel_size=9, padding='same',activation=activ,name="my_conv2d_11")(x)
                ...
                x = layers.Conv2D(filters=64,kernel_size=9,padding='same', activation=activ,name="my_conv2d_2")(x)
