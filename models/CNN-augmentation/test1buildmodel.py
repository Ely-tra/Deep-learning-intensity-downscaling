    ...
    for dense_layer in dense_layers:
        for layer_size in layer_sizes:
            for conv_layer in conv_layers:
                ...
                x = layers.Conv2D(filters=64,kernel_size=7, padding='same',activation=activ,name="my_conv2d_11")(x)
                ...
                x = layers.Conv2D(filters=layer_size*2,kernel_size=3, activation=activ,name="my_conv2d_2")(x)
                x = layers.MaxPooling2D(pool_size=2,name="my_pooling_2")(x)
                #x=tf.keras.layers.BatchNormalization()(x)
                x = layers.Conv2D(filters=layer_size*4,kernel_size=conv_layer,activation=activ,name="my_conv2d_3")(x)
