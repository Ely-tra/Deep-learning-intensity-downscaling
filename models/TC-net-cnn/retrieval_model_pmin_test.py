...
def main(X, y, loss='huber', activ='relu', NAME='best_model'):
    ...
    x = layers.Conv2D(filters=32, kernel_size=15, padding='same', activation=activ, name="my_conv2d_11")(x)
...
best_model_name = root + '/model_'+mode+str(var_num)+'_'+windows+'test'
